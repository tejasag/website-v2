...
import 'net';
import { fileURLToPath, pathToFileURL, resolve as resolve$1 } from 'url';
...
const prog = sade('svelte-kit').version('1.0.0-next.76');
...
prog
	...
	.action(async ({ port, host, https, open }) => {
		...
		const { start } = await import('./chunks/index7.js');
...
export { $, copy_assets as c, logger as l, posixify as p, resolve_entry as r };
