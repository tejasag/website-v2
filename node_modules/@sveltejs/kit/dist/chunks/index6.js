import { $, l as logger } from '../cli.js';
import { mkdirp, rimraf, copy } from '../filesystem.js';
 ...
 * }} opts */
async function prerender({ cwd, out, log, config, build_data, force }) {
	const dir = resolve(cwd, '.svelte/output');
